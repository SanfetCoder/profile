...
const techStackImages: any = {
  ...
  Omise:
    "https://pbs.twimg.com/profile_images/1141906269097168897/jYzpfxho_400x400.png",
  Supabase:
  ...
  Flask:
    "https://giulianopertile.com/uploads/post/review-of-flask-from-a-django-developer/flask-logo-version-2.png",
  MongoDB: "https://repvue.imgix.net/a9yxc48y3ay5dm2udzwizc2bdyph",
  FastAPI:
    "https://cdn.try.direct/files/8400033b-cf2e-4fc4-ac91-45cadee082ed.svg",
  Sanity: "https://www.sanity.io/static/images/logo_rounded_square.png",
  Javascript:
    "https://durableprogramming.com/wp-content/uploads/2023/04/JavaScript-logo.png",
};
...
const MyWorks: FC<{
  ...
  return (
    ...
    >
      ...
      <ul className="lg:grid grid-cols-4 gap-5 flex flex-col">
        {works.map((work) => (
...
const WorkCard: FC<{
  ...
  return (
    <a
      ...
      className="bg-white w-[300px] h-[300px] p-3 rounded-2xl overflow-hidden hover:scale-105 transition-all"
    >
      <Image
        alt={work.title}
      ...
      <ul className="flex w-full gap-x-2 mt-3">
        {work.techStacks.map((stack: string) => (
          <Image
            key={stack}
            className="w-max h-[35px] object-cover"
