...
const AboutMe = () => {
  return (
    <section className='mt-16 w-1/2'>
      ...
      <pre data-prefix="6" className='text-warning'><code>{`  `}</code></pre> 
      <pre data-prefix="6" className='text-success'><code>{`  speak(){`}</code></pre> 
      <pre data-prefix="6"><code>{`    console.log('English')`}</code></pre> 
      <pre data-prefix="6"><code>{`    console.log('Thai')`}</code></pre> 
      <pre data-prefix="6"><code>{`    console.log('Spanish')`}</code></pre> 
      <pre data-prefix="6"><code>{`    console.log('Chinese')`}</code></pre> 
      <pre data-prefix="6" className='text-success'><code>{`  }`}</code></pre> 
      <pre data-prefix="7" className='text-success'><code>{`}`}</code></pre>
    </div>
    </section>
  )
}
